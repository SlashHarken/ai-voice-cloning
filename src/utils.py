...
try:
    ...
    from bark.generation import SAMPLE_RATE as BARK_SAMPLE_RATE, ALLOWED_PROMPTS, preload_models, codec_decode, \
        generate_coarse, generate_fine, generate_text_semantic, load_codec_model
...
def load_tts(restart=False,
    ...
    if args.tts_backend == "tortoise":
        ...
        tts = TorToise_TTS(minor_optimizations=not args.low_vram, autoregressive_model_path=autoregressive_model,
                           diffusion_model_path=diffusion_model, vocoder_model=vocoder_model,
                           tokenizer_json=tokenizer_json, unsqueeze_sample_batches=args.unsqueeze_sample_batches,
